...
class FinalizationRoutesApi extends runtime.BaseAPI {
     ...
     */
    getFinalizationProofAtEpochRaw(requestParameters) {
    ...
    getFinalizationProofAtEpoch(epoch) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getFinalizationProofAtEpochRaw({ epoch: epoch });
     ...
     * Get finalization proof
     */
    getFinalizationProofAtHeightRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getFinalizationProofAtHeight(height) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getFinalizationProofAtHeightRaw({ height: height });
            return yield response.value();
        });
    }
}
