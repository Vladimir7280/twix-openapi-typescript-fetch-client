...
class HashLockRoutesApi extends runtime.BaseAPI {
     ...
     */
    getHashLockRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.HashLockInfoDTOFromJSON(jsonValue));
        });
    }
    /**
     * Gets the hash lock for a given hash.
    ...
    getHashLock(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getHashLockRaw({ hash: hash });
     ...
     */
    getHashLockMerkleRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hash === null || requestParameters.hash === undefined) {
    ...
    getHashLockMerkle(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getHashLockMerkleRaw({ hash: hash });
            return yield response.value();
        });
    }
    /**
     ...
     */
    searchHashLockRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.HashLockPageFromJSON(jsonValue));
        });
    }
    /**
     * Returns an array of hash locks.
    ...
    searchHashLock(address, pageSize, pageNumber, offset, order) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchHashLockRaw({ address: address, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
            return yield response.value();
        });
    }
}
