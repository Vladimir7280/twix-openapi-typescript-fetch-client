...
class RestrictionAccountRoutesApi extends runtime.BaseAPI {
    ...
    getAccountRestrictions(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getAccountRestrictionsRaw({ address: address });
     ...
     */
    getAccountRestrictionsMerkleRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.address === null || requestParameters.address === undefined) {
    ...
    getAccountRestrictionsMerkle(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getAccountRestrictionsMerkleRaw({ address: address });
            return yield response.value();
        });
    }
    /**
     ...
     */
    searchAccountRestrictionsRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models_1.AccountRestrictionsPageFromJSON(jsonValue));
        });
    }
    /**
     * Returns an array of account restrictions.
     * Search account restrictions
     */
    searchAccountRestrictions(address, pageSize, pageNumber, offset, order) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchAccountRestrictionsRaw({ address: address, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
            return yield response.value();
        });
    }
}
