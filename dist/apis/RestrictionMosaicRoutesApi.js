...
class RestrictionMosaicRoutesApi extends runtime.BaseAPI {
     ...
     */
    getMosaicRestrictionsRaw(requestParameters) {
    ...
    getMosaicRestrictions(compositeHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMosaicRestrictionsRaw({ compositeHash: compositeHash });
     ...
     */
    getMosaicRestrictionsMerkleRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
    ...
    getMosaicRestrictionsMerkle(compositeHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMosaicRestrictionsMerkleRaw({ compositeHash: compositeHash });
            return yield response.value();
        });
    }
    /**
     ...
     */
    searchMosaicRestrictionsRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
     ...
     * Search mosaic restrictions
     */
    searchMosaicRestrictions(mosaicId, entryType, targetAddress, pageSize, pageNumber, offset, order) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchMosaicRestrictionsRaw({ mosaicId: mosaicId, entryType: entryType, targetAddress: targetAddress, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
            return yield response.value();
        });
    }
}
