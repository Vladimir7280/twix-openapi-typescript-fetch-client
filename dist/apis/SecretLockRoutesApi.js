...
class SecretLockRoutesApi extends runtime.BaseAPI {
    ...
    getSecretLock(compositeHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getSecretLockRaw({ compositeHash: compositeHash });
     ...
     */
    getSecretLockMerkleRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
    ...
    getSecretLockMerkle(compositeHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getSecretLockMerkleRaw({ compositeHash: compositeHash });
            return yield response.value();
        });
    }
    /**
     ...
     * Search secret lock entries
     */
    searchSecretLock(address, secret, pageSize, pageNumber, offset, order) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchSecretLockRaw({ address: address, secret: secret, pageSize: pageSize, pageNumber: pageNumber, offset: offset, order: order });
            return yield response.value();
        });
    }
}
