...
class MetadataRoutesApi extends runtime.BaseAPI {
     ...
     */
    getMetadataRaw(requestParameters) {
    ...
    getMetadata(compositeHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMetadataRaw({ compositeHash: compositeHash });
     ...
     */
    getMetadataMerkleRaw(requestParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.compositeHash === null || requestParameters.compositeHash === undefined) {
    ...
    getMetadataMerkle(compositeHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMetadataMerkleRaw({ compositeHash: compositeHash });
            return yield response.value();
        });
    }
    /**
