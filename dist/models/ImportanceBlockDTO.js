...
exports.ImportanceBlockDTOToJSON = exports.ImportanceBlockDTOFromJSONTyped = exports.ImportanceBlockDTOFromJSON = void 0;
function ImportanceBlockDTOFromJSON(json) {
    return ImportanceBlockDTOFromJSONTyped(json, false);
}
exports.ImportanceBlockDTOFromJSON = ImportanceBlockDTOFromJSON;
function ImportanceBlockDTOFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ImportanceBlockDTOFromJSONTyped = ImportanceBlockDTOFromJSONTyped;
function ImportanceBlockDTOToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ImportanceBlockDTOToJSON = ImportanceBlockDTOToJSON;
