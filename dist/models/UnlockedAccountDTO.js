...
exports.UnlockedAccountDTOToJSON = exports.UnlockedAccountDTOFromJSONTyped = exports.UnlockedAccountDTOFromJSON = void 0;
function UnlockedAccountDTOFromJSON(json) {
...
function UnlockedAccountDTOToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
