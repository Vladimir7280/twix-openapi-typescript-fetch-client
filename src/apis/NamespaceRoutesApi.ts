...
export class NamespaceRoutesApi extends runtime.BaseAPI {
     ...
     */
    async getNamespaceMerkleRaw(requestParameters: GetNamespaceMerkleRequest): Promise<runtime.ApiResponse<MerkleStateInfoDTO>> {
        if (requestParameters.namespaceId === null || requestParameters.namespaceId === undefined) {
     ...
     * Get namespace merkle information
     */
    async getNamespaceMerkle(namespaceId: string): Promise<MerkleStateInfoDTO> {
        const response = await this.getNamespaceMerkleRaw({ namespaceId: namespaceId });
        return await response.value();
    }
